// 迁移自: 1.0.0: com.renderium.core.precision.AdaptivePrecisionManager
// 迁移目标: com.ranecc.renderium.domain.service.precision
 ...
 * @since 3.0.0
 * @see AdaptivePrecision (本类内部枚举)
 * @see com.ranecc.renderium.domain.constant.ConfigConstants
 */
