...
public final class PipelineNodeRegistry {
    ...
    public synchronized void registerBuiltinNodes() {
        ...
        // ===== 预计算阶段 (PRE_RENDER) =====
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.ShadowMapNode");

        // ===== G-Buffer 阶段 (GBUFFER) =====
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.GBufferGeometryNode");

        // ===== 后处理阶段 (POST_PROCESS) =====
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.FilmGrainNode");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.SSAO");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.Bloom");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.Tonemap");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.DepthOfFieldEnhancedNode");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.MotionBlurEnhancedNode");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.SSRNode");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.LensFlareNode");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.ChromaticAberrationNode");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.AutoExposureNode");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.VolumetricFogNode");
        registerBuiltinNode("com.ranecc.renderium.feature.shader.pipeline.node.builtin.TemporalAANode");
     ...
     *
     * @param className 完整类名（如 "com.ranecc.renderium.feature.shader.pipeline.node.builtin.ShadowMapNode"）
     */
