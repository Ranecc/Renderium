...
package com.ranecc.renderium.feature.shader.pipeline.node.builtin.postprocess.effects;
...
public class FilmGrainNode extends AbstractPipelineNode {
    ...
    protected String shaderKey() {
        return "pipeline/postprocess/effects/film_grain";
    }
     ...
     *
     * 【方法参数】
     * @param path String - 资源路径（如 "/shaders/pipeline/postprocess/effects/film_grain.spv"）
     *
     * 【返回值】
