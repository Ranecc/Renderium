...
import com.ranecc.renderium.infrastructure.config.builder.RendererConfigBuilder;
import com.ranecc.renderium.infrastructure.config.builder.OptionGroupBuilder;
/**
 * Shader 设置选项注册器
 * <p>
