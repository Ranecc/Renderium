...
public final class VulkanConst {
    ...
    /** VK_FORMAT_R8G8B8A8_UNORM - 4通道8位无符号归一�?*/
    ...
    /** VK_FORMAT_B8G8R8A8_UNORM - BGRA格式无符号归一�?*/
    ...
    /** VK_FORMAT_R32_SFLOAT - 单通道32位浮�?*/
    public static final int FORMAT_R32_SFLOAT = 100;
    /** VK_FORMAT_R32G32_SFLOAT - 双通道32位浮�?*/
    public static final int FORMAT_R32G32_SFLOAT = 103;
    /** VK_FORMAT_R32G32B32A32_SFLOAT - 四通道32位浮�?*/
    ...
    /** VK_FORMAT_D24_UNORM_S8_UINT - 24位深�?8位模�?*/
    ...
    /** VK_FORMAT_X8_D24_UNORM_PACK32 - 打包�?4位深度（无模板） */
    public static final int FORMAT_X8_D24_UNORM_PACK32 = 127;
    /** VK_FORMAT_D32_SFLOAT_S8_UINT - 32位浮点深�?8位模�?*/
    public static final int FORMAT_D32_SFLOAT_S8_UINT = 128;

    // ==================== 颜色空间 ====================
    /** VK_COLOR_SPACE_SRGB_NONLINEAR_KHR - 标准sRGB非线性颜色空�?*/
    ...
    /** Image 可用于存�?(VK_IMAGE_USAGE_STORAGE_BIT) */
    ...
    /** Image 可用于传输目�?(VK_IMAGE_USAGE_TRANSFER_DST_BIT) */
    ...
    /** Buffer 可用于传输目�?(VK_BUFFER_USAGE_TRANSFER_DST_BIT) */
    public static final int BUFFER_USAGE_TRANSFER_DST_BIT = 0x00000002;
    /** Buffer 可用�?Uniform Texel Buffer (VK_BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT) */
    public static final int BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT = 0x00000004;
    /** Buffer 可用�?Storage Texel Buffer (VK_BUFFER_USAGE_STORAGE_TEXEL_BUFFER_BIT) */
    public static final int BUFFER_USAGE_STORAGE_TEXEL_BUFFER_BIT = 0x00000008;
    /** Buffer 可用�?Uniform Buffer (VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT) */
    public static final int BUFFER_USAGE_UNIFORM_BUFFER_BIT = 0x00000010;
    /** Buffer 可用�?Storage Buffer (VK_BUFFER_USAGE_STORAGE_BUFFER_BIT) */
    ...
    /** Buffer 可用于间接绘�?(VK_BUFFER_USAGE_INDIRECT_BUFFER_BIT) */
    ...
    /** 剔除正面和背�?(VK_CULL_MODE_FRONT_AND_BACK) */
    ...
    /** Blend 操作: 最小�?(VK_BLEND_OP_MIN) */
    public static final int BLEND_OP_MIN = 3;
    /** Blend 操作: 最大�?(VK_BLEND_OP_MAX) */
    ...
    /** 存储操作: 不关心内�?(VK_ATTACHMENT_STORE_OP_DONT_CARE) */
    ...
    // ==================== Descriptor Type ====================
    /** 描述符类�? Uniform Buffer (VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER) */
    public static final int DESCRIPTOR_TYPE_UNIFORM_BUFFER = 0;
    /** 描述符类�? Combined Image Sampler (VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER) */
    public static final int DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER = 1;
    /** 描述符类�? Sampled Image (VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE) */
    public static final int DESCRIPTOR_TYPE_SAMPLED_IMAGE = 2;
    /** 描述符类�? Storage Image (VK_DESCRIPTOR_TYPE_STORAGE_IMAGE) */
    public static final int DESCRIPTOR_TYPE_STORAGE_IMAGE = 3;
    /** 描述符类�? Uniform Texel Buffer (VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER) */
    public static final int DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER = 4;
    /** 描述符类�? Storage Texel Buffer (VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER) */
    public static final int DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER = 5;
    /** 描述符类�? Storage Buffer (VK_DESCRIPTOR_TYPE_STORAGE_BUFFER) */
    public static final int DESCRIPTOR_TYPE_STORAGE_BUFFER = 6;
    /** 描述符类�? Uniform Buffer Dynamic (VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC) */
    public static final int DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC = 7;
    /** 描述符类�? Storage Buffer Dynamic (VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC) */
    public static final int DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC = 8;
    /** 描述符类�? Input Attachment (VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT) */
