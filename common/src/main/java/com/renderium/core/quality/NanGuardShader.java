// ============================================================
// 【包迁移说明】
// 原始位置: com.renderium.core.NanGuardShader
// 迁移时间: 2026-04-25
// 迁移原因: Core 包重构，按功能域划分子包
// 新位置: com.renderium.core.quality.NanGuardShader
//
// 注意事项:
//   - 此文件为从原位置自动迁移的副本
//   - package 声明已更新为新子包
...
public final class NanGuardShader {
     ...
     *
     * // 方式2: 直接拼接
     * String shaderSource = NanGuardShader.getGlslLibrary() + "\n" + myShader;
     * }</pre>
     *
    ...
    private static final String GLSL_NAN_GUARD_CLAMP =
        "// ================================================\n" +
        "// NanGuard: nanGuardClamp - 带 NaN/Inf 检测的安全钳位\n" +
        "// ================================================\n" +
        "// 参数:\n" +
    ...
    private static final String GLSL_LIBRARY =
       ...
       ">// 作者: Renderium Team\n" +
        ...
        "#define NANGUARD_EPSILON 1e-6          // NaN 检测的 epsilon 阈值\n" +
        "#endif\n" +
        "\n" +
        "#ifndef NANGUARD_MIN_NORMALIZE_LENGTH\n" +
        "#define NANGUARD_MIN_NORMALIZE_LENGTH 1e-8  // 最小安全归一化长度\n" +
        "#endif\n" +
        "\n" +
        "#ifndef NANGUARD_DEFAULT_SAFE_VALUE\n" +
        "#define NANGUARD_DEFAULT_SAFE_VALUE 0.0      // 默认安全值\n" +
        "#endif\n" +
        "\n" +
        "#ifndef NANGUARD_DIVIDE_EPSILON\n" +
        "#define NANGUARD_DIVIDE_EPSILON 1e-6         // 除零检测的 epsilon\n" +
        "#endif\n" +
        "\n" +
        GLSL_NAN_GUARD_CLAMP + "\n\n" +
        GLSL_SAFE_NORMALIZE + "\n\n" +
        GLSL_SAFE_DIVIDE + "\n\n" +
        "// ================================================\n" +
        "// 便捷包装函数（使用默认参数）\n" +
